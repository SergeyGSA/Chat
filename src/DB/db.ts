import {IChat} from 'src/app/chat/types/chat.interface'
...
export const chats: IChat[] = [
  {
    ...
    history: [
      ...
      {
        text:
          "Chuck Norris doesn't take Viagra. But if he ever did, his penis could knock down a giant redwood tree.",
        date: 1661456325089,
        direction: 'to',
      },
      {
      ...
      {
        text: "Chuck Norris isn't gay, He's beyond gay.",
        date: 1661456362694,
        direction: 'to',
      },
    ],
  ...
  },
  {
    ...
    name: 'Kate',
    photo:
      'https://kartinkin.net/uploads/posts/2022-03/1647121567_1-kartinkin-net-p-kartinki-litso-devushki-1.png',
    history: [],
  },
  {
    id: '004',
    name: 'Jon Snow',
    photo: 'https://i.ytimg.com/vi/1MFX1axYqOo/maxresdefault.jpg',
    history: [
      {
